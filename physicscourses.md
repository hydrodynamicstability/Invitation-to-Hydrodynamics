...
George K. Batchelor's review of the first English edition in *JFM* (8:  315-318) rightly states that "this is a book by theorists and for theorists".  For the second English edition (205:  593-594), Batchelor concluded:
> This book will continue to be a rich source of understanding of fluid mechanics for adequately prepared readers.  It is not a systematic pedagogical text suitable for use as an adjunct to teaching.  There is little about applications or experiments or empirical data.  But for those who would like to be able to reason their way through fundamental fluid mechanics consistently, and find they need some guidance, there is no better aid than Landau & Lifshitz's *Fluid Mechanics*.
...
Further comments are forthcoming.
