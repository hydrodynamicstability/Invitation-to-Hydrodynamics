...
- David Tong, 2025:  *Fluid Mechanics*.  Cambridge University Press.
    ...
    - Tong is a theoretical physicist (no relation) in the U.K.  His *Lectures on Theoretical Physics* are available online and are very popular.  Cambridge University Press has issued somewhat enhanced versions of the first four volumes in the summer of 2025; volume 4 is on *Fluid Mechanics*.  Problems are not included, but the author's [website](https://www.damtp.cam.ac.uk/user/tong/books/fluids.html) provides exercise sets from Cambridge University's courses, corresponding to the first four chapters of the book.  Errata are also provided there.  Unusually, the last two chapters are on kinetic theory of gases and on diffusion, respectively, topics more commonly encountered in a statistical physics course.  The kinetic theory chapter focuses on showing how the Navier-Stokes equations arise from kinetic theory.  See my further comments on this book at a [companion page](physicscourses.md).
